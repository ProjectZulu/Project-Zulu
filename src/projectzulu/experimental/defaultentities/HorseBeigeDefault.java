...
public class HorseBeigeDefault extends DefaultSpawnable{
	
	public HorseBeigeDefault(){
		super("Horse Beige", EntityHorseBeige.class);		
	...
	public void outputDataToList() {
		if(shouldExist){
			...
			CustomEntityList.horseBeige = Optional.of(customMobData);	
		}
	}
}

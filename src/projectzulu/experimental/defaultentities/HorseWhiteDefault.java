...
public class HorseWhiteDefault extends DefaultSpawnable{
	
	public HorseWhiteDefault(){
		super("Horse White", EntityHorseWhite.class);		
	...
	public void outputDataToList() {
		if(shouldExist){
			...
			CustomEntityList.horseWhite = Optional.of(customMobData);	
		}
	}
}

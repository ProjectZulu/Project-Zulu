...
public class CommandPlaySound extends CommandBase{
	...
	public void processCommand(ICommandSender commandSender, String[] stringArgs) {
		if(stringArgs.length < 2){
			...
			PacketManagerPlaySound playSoundPM = (PacketManagerPlaySound) PacketIDs.playSound.createPacketManager();
			playSoundPM.setPacketData(soundTargetX, soundTargetY, soundTargetZ, stringArgs[1]);
			PacketDispatcher.sendPacketToAllAround(soundTargetX, soundTargetY, soundTargetZ, soundRange, targetPlayer.dimension, playSoundPM.createPacket());
		}
	}

...
public class GuiBrewingStandSingle extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        String s = StatCollector.translateToLocal(this.brewingStand.getInvName());
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (brewingStand.getSizeInventory() - 1 < 3) {
            this.mc.renderEngine.bindTexture(DefaultProps.coreDiretory + "gui/brewing1.png");
        } else {
            this.mc.renderEngine.bindTexture(DefaultProps.coreDiretory + "gui/brewing3.png");
        }

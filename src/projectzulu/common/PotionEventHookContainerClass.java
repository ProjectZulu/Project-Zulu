...
//		if( event.entityLiving.isPotionActive(ProjectZulu_Blocks.thorn) && event.source.getSourceOfDamage() instanceof EntityLiving ){
//			EntityLiving hurtEntity = event.entityLiving;
//			EntityLiving attackingEntity = (EntityLiving)event.source.getSourceOfDamage();
//			
//			PotionEffect thornsEffect = event.entityLiving.getActivePotionEffect(ProjectZulu_Blocks.thorn);

...
public class HorseBrownDeclaration extends SpawnableDeclaration{
    ...
    public RenderLiving getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, DefaultProps.mobDiretory + "Horse/horse_brown.png",
                DefaultProps.mobDiretory + "Horse/horse_brown_saddled.png");
    }
}
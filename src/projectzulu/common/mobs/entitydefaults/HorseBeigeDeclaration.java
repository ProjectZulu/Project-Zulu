...
public class HorseBeigeDeclaration extends SpawnableDeclaration{
	...
	public HorseBeigeDeclaration(){
		super("Horse Beige", EntityHorseBeige.class, EnumCreatureType.creature);		
    ...
    public RenderLiving getEntityrender(Class<? extends EntityLivingBase> entityClass) {
        return new RenderGenericHorse(new ModelHorse(), 0.5f, DefaultProps.mobDiretory + "Horse/horse_beige.png",
                DefaultProps.mobDiretory + "Horse/horse_beige_saddled.png");
    }
}
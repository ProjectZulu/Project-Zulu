...
//      if(var5.eBOTMOROT.isSetup == false){var5.eBOTMOROT.setup(BOTMOROT);}
	  ...
	  if (var5.isHidden) {
	      ...
	      REARROT.rotateAngleY = (float)( MathHelper.cos(animSpeed*par2*0.6662F					 ) * 0.5F * par3);
	      REARROT2.rotateAngleY = (float)( MathHelper.cos(animSpeed*par2*0.6662F - (float)Math.PI/3) * 0.5F * par3);
	      REARROT3.rotateAngleY = (float)( MathHelper.cos(animSpeed*par2*0.6662F - (float)Math.PI*2/3) * 0.5F * par3);
	      REARROT4.rotateAngleY = (float)( MathHelper.cos(animSpeed*par2*0.6662F - (float)Math.PI) * 0.5F * par3);

...
public class ModelArmadillo extends ModelBase {
  ...
  public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4){
      ...
      if(var5.eWHOLE.isSetup == false){var5.eWHOLE.setup(WHOLE);}
      if(var5.eHEADPIECE.isSetup == false){var5.eHEADPIECE.setup(HEADPIECE);}
      if(var5.eREARRTR1.isSetup == false){var5.eREARRTR1.setup(REARRTR1);}
      if(var5.eREARRTR2.isSetup == false){var5.eREARRTR2.setup(REARRTR2);}
      if(var5.eREARRTR3.isSetup == false){var5.eREARRTR3.setup(REARRTR3);}
      if(var5.etail.isSetup == false){var5.etail.setup(tail);}
      if(var5.eleg3.isSetup == false){var5.eleg3.setup(leg3);}
      if(var5.eleg4.isSetup == false){var5.eleg4.setup(leg4);}
      ...
      if(var5.getEntityState() == EntityStates.inCover || var5.isCharging()==true){
    	  ...
    	  REARRTR2.rotateAngleX = var5.eREARRTR2.rotateX(+0.01f*animSpeed,(float)(-44*Math.PI/180f),0f);  	  
    	  REARRTR3.rotateAngleX = var5.eREARRTR3.rotateX(+0.01f*animSpeed,(float)(-44*Math.PI/180f),0f);
    	  tail.rotateAngleX = var5.etail.rotateX(-0.1f*animSpeed, (float)(-15*Math.PI/180f), (float)(30*Math.PI/180f));

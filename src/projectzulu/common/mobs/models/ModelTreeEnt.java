...
public class ModelTreeEnt extends ModelBase{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		if(var5.getAnimTime() > var5.maxAnimTime*7/8){
			...
			ARMRIGTOPROT.rotateAngleZ = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -75*Math.PI/180 ),(float)( -5*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( 15*Math.PI/180 ),(float)( -5*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleY = 0.0f;
			ARMRIGBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -110*Math.PI/180 ),(float)( -80*Math.PI/180 ));

			ARMLEFTOPROT.rotateAngleZ = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( 75*Math.PI/180 ),(float)( 5*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( 15*Math.PI/180 ),(float)( -5*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleY = 0.0f;
			ARMLEFBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -110*Math.PI/180 ),(float)( -80*Math.PI/180 ));			
			...
			ARMRIGTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -60*Math.PI/180 ),(float)( 15*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleY = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( 30*Math.PI/180 ),(float)( 0*Math.PI/180 ));
			ARMRIGBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -80*Math.PI/180 ),(float)( -110*Math.PI/180 ));

			ARMLEFTOPROT.rotateAngleZ = (float)( 75*Math.PI/180 );
			ARMLEFTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -60*Math.PI/180 ),(float)( 15*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleY = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -30*Math.PI/180 ),(float)( 0*Math.PI/180 ));
			ARMLEFBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -80*Math.PI/180 ),(float)( -110*Math.PI/180 ));
		}else if(var5.getAnimTime() > var5.maxAnimTime*5/8){
			maxTime = var5.maxAnimTime*6/8;
			minTime = var5.maxAnimTime*5/4;

			ARMRIGTOPROT.rotateAngleZ = (float)( -75*Math.PI/180 );
			ARMRIGTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( 15*Math.PI/180 ),(float)( -60*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleY = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( 30*Math.PI/180 ));
			ARMRIGBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -110*Math.PI/180 ),(float)( -80*Math.PI/180 ));

			ARMLEFTOPROT.rotateAngleZ = (float)( 75*Math.PI/180 );
			ARMLEFTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( 15*Math.PI/180 ),(float)( -60*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleY = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( -30*Math.PI/180 ));
			ARMLEFBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(),minTime, maxTime,(float)( -110*Math.PI/180 ),(float)( -80*Math.PI/180 ));			
		}else if(var5.maxAnimTime > 0){
			maxTime = var5.maxAnimTime*5/4;
			minTime = 0;

			ARMRIGTOPROT.rotateAngleZ = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -5*Math.PI/180 ),(float)( -75*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -5*Math.PI/180 ),(float)( 15*Math.PI/180 ));
			ARMRIGTOPROT.rotateAngleY = 0.0f;
			ARMRIGBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -80*Math.PI/180 ),(float)( -110*Math.PI/180 ));

			ARMLEFTOPROT.rotateAngleZ = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( 5*Math.PI/180 ),(float)( 75*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -5*Math.PI/180 ),(float)( 15*Math.PI/180 ));
			ARMLEFTOPROT.rotateAngleY = 0.0f;
			ARMLEFBOTROT.rotateAngleX = mapValueofSet1ToSet2(var5.getAnimTime(), minTime, maxTime, (float)( -80*Math.PI/180 ),(float)( -110*Math.PI/180 ));
		}

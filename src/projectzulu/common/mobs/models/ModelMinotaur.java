	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		if(var5.getAnimTime() > 0 && var5.getEntityState() == (EntityStates.attacking)){
			...
			if(animState == 0){
				...
				BODYROT.rotateAngleX = (float) mapValueWithClamp(var5.getAnimTime(), var5.maxAnimTime, 10, (float)( 5*Math.PI/180 ), (float)( 20*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleX = (float)mapValueWithClamp(var5.getAnimTime(), var5.maxAnimTime, 10, (float)( 165*Math.PI/180 ), (float)( 350*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleY = (float)(0*Math.PI/180);
				...
				ARMTOPRIGROT.rotateAngleX = (float)mapValueWithClamp(var5.getAnimTime(), var5.maxAnimTime, 10, (float)( 165*Math.PI/180 ), (float)( 350*Math.PI/180 ));
				ARMTOPRIGROT.rotateAngleY = (float)(0*Math.PI/180);

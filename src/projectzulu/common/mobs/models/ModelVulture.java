...
public class ModelVulture extends ModelBase
{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4){
		...
		if(var5.eFEETROT.isSetup == false){var5.eFEETROT.setup(FEETROT);}
		if(var5.eBODYROT.isSetup == false){var5.eBODYROT.setup(BODYROT);}

		if(var5.eLEFTWING.isSetup == false){var5.eLEFTWING.setup(LEFTWING);}
		if(var5.ewingleft4.isSetup == false){var5.ewingleft4.setup(wingleft4);}
		if(var5.ewingleft3.isSetup == false){var5.ewingleft3.setup(wingleft3);}
		if(var5.ewingleft2.isSetup == false){var5.ewingleft2.setup(wingleft2);}
		if(var5.ewingleft1.isSetup == false){var5.ewingleft1.setup(wingleft1);}

		if(var5.eRIGTHWING.isSetup == false){var5.eRIGTHWING.setup(RIGTHWING);}
		if(var5.ewingrig4.isSetup == false){var5.ewingrig4.setup(wingrig4);}
		if(var5.ewingrig3.isSetup == false){var5.ewingrig3.setup(wingrig3);}
		if(var5.ewingrig2.isSetup == false){var5.ewingrig2.setup(wingrig2);}
		if(var5.ewingrig1.isSetup == false){var5.ewingrig1.setup(wingrig1);}

		if(var5.eNECKROT1.isSetup == false){var5.eNECKROT1.setup(NECKROT1);}
		if(var5.eNECKROT2.isSetup == false){var5.eNECKROT2.setup(NECKROT2);}
		if(var5.eNECKROT3.isSetup == false){var5.eNECKROT3.setup(NECKROT3);}

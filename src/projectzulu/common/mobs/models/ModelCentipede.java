...
public class ModelCentipede extends ModelBase{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		ANTENLEFROT2.rotateAngleX = (float) (-15*Math.PI/180 + 20*Math.PI/180*MathHelper.cos(par2*0.6662F + (float)Math.PI));
		ANTENLEFROT3.rotateAngleX = (float) (-15*Math.PI/180 + 20*Math.PI/180*MathHelper.cos(par2*0.6662F + (float)Math.PI));

		ANTENRIGROT2.rotateAngleX = (float) (-15*Math.PI/180 + 20*Math.PI/180*MathHelper.cos(par2*0.6662F + (float)Math.PI));
		ANTENRIGROT3.rotateAngleX = (float) (-15*Math.PI/180 + 20*Math.PI/180*MathHelper.cos(par2*0.6662F + (float)Math.PI));

		LEG11ROT.rotateAngleY = (float)( MathHelper.cos(par2*0.6662F + (float)Math.PI) * 1.4F * par3);
		LEG21ROT.rotateAngleY = (float)( MathHelper.cos(par2*0.6662F			   	 ) * 1.4F * par3);
		LEG31ROT.rotateAngleY = (float)( MathHelper.cos(par2*0.6662F + (float)Math.PI) * 1.4F * par3);
		LEG41ROT.rotateAngleY = (float)( MathHelper.cos(par2*0.6662F				 ) * 1.4F * par3);
	}

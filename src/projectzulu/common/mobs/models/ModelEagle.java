...
public class ModelEagle extends ModelBase {
	...
	setTextureOffset("HEADROT.head", 10, 16);
	setTextureOffset("HEADROT.beaktop", 22, 16);
	setTextureOffset("HEADROT.beakbot", 22, 20);
	setTextureOffset("TAILBASEROT.tailbase2", 8, 10);
	setTextureOffset("TAILFEATHER1ROT.tailfeather1", 9, 8);
	setTextureOffset("TAILFEATHER3ROT.tailfeather3", 9, 8);
	setTextureOffset("TAILFEATHER2ROT.tailfeather2", 9, 8);
	setTextureOffset("TAILFEATHER4ROT.tailfeather4", 9, 8);
	setTextureOffset("TAILFEATHER5ROT.tailfeather5", 9, 8);
	...
	BODYROT.setRotationPoint(0F, 17F, 2.5F);
	...
	HEADROT.setRotationPoint(0F, -1F, -6.5F);
	setRotation(HEADROT, 0F, 0F, 0F);
	HEADROT.mirror = true;
	HEADROT.addBox("head", -1.5F, -1.5F, -2F, 3, 3, 2);
	HEADROT.addBox("beaktop", -1F, -0.5F, -5F, 2, 1, 3);
	HEADROT.addBox("beakbot", -0.5F, 0.5F, -4F, 1, 1, 2);
	...
	TAILFEATHER1ROT.addBox("tailfeather1", -0.5F, -0.5F, 0F, 1, 1, 5);
	...
	TAILFEATHER3ROT.addBox("tailfeather3", -0.5F, -0.5F, 0F, 1, 1, 5);
	...
	setRotation(TAILFEATHER2ROT, 0F, 0.5235988F, 0F);
	TAILFEATHER2ROT.mirror = true;
	TAILFEATHER2ROT.addBox("tailfeather2", -0.5F, -0.5F, 0F, 1, 1, 5);
	...
	setRotation(TAILFEATHER4ROT, 0F, -0.5235988F, 0F);
	TAILFEATHER4ROT.mirror = true;
	TAILFEATHER4ROT.addBox("tailfeather4", -0.5F, -0.5F, 0F, 1, 1, 5);
	...
	TAILFEATHER5ROT.addBox("tailfeather5", -0.5F, -0.5F, 0F, 1, 1, 5);
	...
	LEGRIGTOPROT.addBox("legrigtop", -0.5F, 0F, -0.5F, 1, 3, 1);
	LEGRIGBOTROT = new ModelRenderer(this, "LEGRIGBOTROT");
	LEGRIGBOTROT.setRotationPoint(0F, 3F, 0F);
	...
	EntityEagle var5 = (EntityEagle) par1EntityLiving;
	...
	if (var5.getEntityState() == EntityStates.attacking) {
	    ...
	    WINGLEFROT6.rotateAngleZ = (float) (-20 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    WINGLEFROT10.rotateAngleZ = (float) (-25 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    ...
	    WINGLEFROT8.rotateAngleY = (float) (-6 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    WINGLEFROT11.rotateAngleY = (float) (-7 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));

	    WINGRIGROT1.rotateAngleZ = (float) (-40 * Math.PI / 180 * MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f + Math.PI * 0 / 2)));
	    WINGRIGROT6.rotateAngleZ = (float) (+20 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    WINGRIGROT10.rotateAngleZ = (float) (+25 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    ...
	    WINGRIGROT8.rotateAngleY = (float) (+6 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));
	    WINGRIGROT11.rotateAngleY = (float) (+7 * Math.PI / 180 * Math.abs(MathHelper.sin((float) (var5.worldObj
		    .getWorldTime() * 0.6662F * 0.5f / 2 + Math.PI * 3 / 4))));

	    TAILFEATHER1ROT.rotateAngleY = (float) (45 * Math.PI / 180 - 10 * Math.PI / 180 * par3);
	    TAILFEATHER2ROT.rotateAngleY = (float) (30 * Math.PI / 180 - 10 * Math.PI / 180 * par3);
	    TAILFEATHER5ROT.rotateAngleY = (float) (-45 * Math.PI / 180 + 10 * Math.PI / 180 * par3);
	    TAILFEATHER4ROT.rotateAngleY = (float) (-30 * Math.PI / 180 + 10 * Math.PI / 180 * par3);
	} else {
	...
	EntityEagle var5 = (EntityEagle) par7Entity;

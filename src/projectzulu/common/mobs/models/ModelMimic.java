...
public class ModelMimic extends ModelBase
{
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
	{
	    ...
	    String textureLocation = "/item/chest.png";
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		EntityMimic var5 = (EntityMimic)par1EntityLiving;
		...
		if(var5.entityState != listStates.idle.index){
		    ...
		    LEG1TOPROT.rotateAngleX = (float) (-10*Math.PI/180) + (float)( MathHelper.cos(par2*0.6662F			   	 ) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		    LEG1TOPROT.rotateAngleZ = (float) (-50*Math.PI/180);
			LEG1BOTROT.rotateAngleZ = (float) (50*Math.PI/180);

		    LEG3TOPROT.rotateAngleX = (float) (+10*Math.PI/180) + (float)( MathHelper.cos(par2*0.6662F			   	 ) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		    LEG3TOPROT.rotateAngleZ = (float) (-50*Math.PI/180);
			LEG3BOTROT.rotateAngleZ = (float) (50*Math.PI/180);

		    LEG2TOPROT.rotateAngleX = (float) (-10*Math.PI/180) + (float)( MathHelper.cos(par2*0.6662F + (float)Math.PI) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		    LEG2TOPROT.rotateAngleZ = (float) (+50*Math.PI/180);
			LEG2BOTROT.rotateAngleZ = (float) (-50*Math.PI/180);

		    LEG4TOPROT.rotateAngleX = (float) (+10*Math.PI/180) + (float)( MathHelper.cos(par2*0.6662F + (float)Math.PI) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
...
//	    botchest.setRotationPoint(botchest.rotationPointX, botchest.rotationPointY, botchest.rotationPointZ);

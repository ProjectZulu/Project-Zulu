...
public class ModelPelican extends ModelBase{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4){
		...
		if(var5.isEntityGrounded()){
			HEADROT.rotateAngleX = (float) (+30*Math.PI/180 - 10*2*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f )) );
			...
			NECK1ROT.rotateAngleX = (float) (+10*Math.PI/180 + 10*2*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f )) );
			...
			LEGLEFTOPROT.rotateAngleX = (float) (+10*Math.PI/180 + 20*2*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f )));
			LEGLEFTOPROT.rotateAngleY = (float) (+0*Math.PI/180);
			LEGLEFBOTROT.rotateAngleX = (float) (+20*Math.PI/180 + 10*2*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f )));
			...
			LEGRIGTOPROT.rotateAngleX = (float) (+10*Math.PI/180+ 20*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f + Math.PI)));
			LEGRIGTOPROT.rotateAngleY = (float) (0*Math.PI/180);
			LEGRIGBOTROT.rotateAngleX = (float) (+20*Math.PI/180+ 10*par3*Math.PI/180*MathHelper.sin((float) (par2*0.6662F*1.0f + Math.PI)));
			...
			if(var5.getEntityState() == EntityStates.attacking){
				...
				FOOTLEF1ROT.rotateAngleX = (float) (45*Math.PI/180 + 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));
				FOOTLEF2ROT.rotateAngleX = (float) (45*Math.PI/180 + 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));
				FOOTLEF3ROT.rotateAngleX = (float) (-45*Math.PI/180 - 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));

				LEGRIGTOPROT.rotateAngleX = (float) (-20*Math.PI/180);
				LEGRIGTOPROT.rotateAngleY = (float) (0*Math.PI/180);
				LEGRIGBOTROT.rotateAngleX = (float) (60*Math.PI/180);
				FOOTRIG1ROT.rotateAngleX = (float) (45*Math.PI/180 + 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));
				FOOTRIG2ROT.rotateAngleX = (float) (45*Math.PI/180 + 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));
				FOOTRIG3ROT.rotateAngleX = (float) (-45*Math.PI/180 - 10*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)));

				/* Left Wing */
				WINGLEFROT1.rotateAngleZ = (float)( 40*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)) );
				WINGLEFROT2.rotateAngleZ = 0;
				WINGLEFROT3.rotateAngleZ = 0;
				WINGLEFROT4.rotateAngleZ = 0;
				WINGLEFROT5.rotateAngleZ = 0;
				WINGLEFROT6.rotateAngleZ = (float)( -20*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGLEFROT7.rotateAngleZ = 0;
				WINGLEFROT8.rotateAngleZ = 0;
				WINGLEFROT8.rotateAngleZ = 0;
				WINGLEFROT10.rotateAngleZ = (float)( -25*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				...
				WINGLEFROT1.rotateAngleY = (float)( -4*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGLEFROT5.rotateAngleY = (float)( -5*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGLEFROT8.rotateAngleY = (float)( -6*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGLEFROT11.rotateAngleY = (float)( -7*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));

				/*  Right Wing */
				WINGRIGROT1.rotateAngleZ = (float)( -40*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)) );
				WINGRIGROT2.rotateAngleZ = 0;
				WINGRIGROT3.rotateAngleZ = 0;
				WINGRIGROT4.rotateAngleZ = 0;
				WINGRIGROT5.rotateAngleZ = 0;
				WINGRIGROT6.rotateAngleZ = (float)( +20*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGRIGROT7.rotateAngleZ = 0;
				WINGRIGROT8.rotateAngleZ = 0;
				WINGRIGROT8.rotateAngleZ = 0;
				WINGRIGROT10.rotateAngleZ = (float)( +25*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				...
				WINGRIGROT1.rotateAngleY = (float)( +4*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGRIGROT5.rotateAngleY = (float)( +5*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGRIGROT8.rotateAngleY = (float)( +6*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
				WINGRIGROT11.rotateAngleY = (float)( +7*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity par7Entity){
		...
		if(var5.isEntityGrounded()){
			HEADROT.rotateAngleX = (float) (+30*Math.PI/180 - 10*2*f1*Math.PI/180*MathHelper.sin((float) (f*0.6662F*1.0f )) ) + lookingDirX;
		}else{
			if(var5.getEntityState() == EntityStates.attacking){

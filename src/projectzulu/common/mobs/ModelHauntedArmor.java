...
//        this.aimedBow = false;
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2,
		...
		if(var5.getEntityState() == EntityStates.idle){
			...
			/* Wake Up Animation */
		}else if(var5.wakeUpTimer > 0){
			float wakeUpTimer = var5.wakeUpTimer;
			...
			/* Attack Animation */
		}else if(var5.animTime > 0 && var5.getEntityState() == EntityStates.attacking){
			mapRotationPoint(swordhand, var5.animTime, var5.maxAnimTime, 0, 0, 9f,-17f,  0, 9f,-8f);
			mapRotation(swordhand, var5.animTime, var5.maxAnimTime, 0, 

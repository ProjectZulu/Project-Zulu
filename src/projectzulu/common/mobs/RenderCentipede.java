...
{
	//private EntityCentipede holdEnt;
    private ModelCentipede holdModel;
	
    public RenderCentipede(ModelBase modelBase, float par1){
        super(modelBase, par1);
        holdModel = (ModelCentipede)modelBase;
    }
    /**

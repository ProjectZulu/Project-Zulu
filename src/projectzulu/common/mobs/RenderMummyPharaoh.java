...
public class RenderMummyPharaoh extends RenderLiving
{
	//private EntityMummyPharaoh holdEnt;
    protected ModelMummyPharaoh modelBipedMain;
    protected static EntityMummyPharaoh entityMummyPharaoh;
    protected float field_77070_b;
	
    public RenderMummyPharaoh(ModelBase modelBase, float par1){

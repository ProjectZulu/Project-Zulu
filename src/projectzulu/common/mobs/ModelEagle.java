...
public class ModelEagle extends ModelBase{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4){
		...
		//On Ground
		if(var5.entityState == EntityStates.attacking){
			...
			WINGLEFROT1.rotateAngleZ = (float) (float)( 40*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)) );
			WINGLEFROT6.rotateAngleZ = (float) (float)( -20*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGLEFROT10.rotateAngleZ = (float) (float)( -25*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGLEFROT1.rotateAngleY = (float) (float)( -4*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGLEFROT5.rotateAngleY = (float) (float)( -5*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGLEFROT8.rotateAngleY = (float) (float)( -6*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGLEFROT11.rotateAngleY = (float) (float)( -7*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));

			WINGRIGROT1.rotateAngleZ = (float) (float)( -40*Math.PI/180*MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f + Math.PI*0/2)) );
			WINGRIGROT6.rotateAngleZ = (float) (float)( +20*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGRIGROT10.rotateAngleZ = (float) (float)( +25*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGRIGROT1.rotateAngleY = (float) (float)( +4*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGRIGROT5.rotateAngleY = (float) (float)( +5*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGRIGROT8.rotateAngleY = (float) (float)( +6*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));
			WINGRIGROT11.rotateAngleY = (float) (float)( +7*Math.PI/180*Math.abs(MathHelper.sin((float) (var5.worldObj.getWorldTime()*0.6662F*0.5f/2 + Math.PI*3/4)) ));

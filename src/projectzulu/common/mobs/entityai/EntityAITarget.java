...
public abstract class EntityAITarget extends EntityAIBase{
    ...
    /* I believe This Toggles whether the final point in the path is evaluated to ensure the Entity can Reach Its Destination : Can be Wonky on Larger Entities */

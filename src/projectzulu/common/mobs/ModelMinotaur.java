...
public class ModelMinotaur extends ModelBase{
	...
	private ModelRenderer LEGRIGRIGROT;
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		LEGLEFTOPROT.rotateAngleX = (float)( MathHelper.cos(par2*0.6662F + (float)Math.PI) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		LEGLEFBOTROT.rotateAngleX = (float) Math.abs( MathHelper.cos(par2*0.6662F/2 + (float)Math.PI) * 1.8F * zeroIfNegative(Math.log(par3+1)) );

		LEGRIGTOPROT.rotateAngleX = (float)( MathHelper.cos(par2*0.6662F			   	 ) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		LEGRIGBOTROT.rotateAngleX = (float) Math.abs( MathHelper.cos(par2*0.6662F/2			   	 ) * 1.8F * zeroIfNegative(Math.log(par3+1)) );
		...
		if(var5.animTime > 0 && var5.getEntityState() == (EntityStates.attacking)){
			int animState = 0;
			if(animState == 0){
				/* Two Handed Attack Anim */ 
				BODYROT.rotateAngleX = (float) mapValueWithClamp(var5.animTime, var5.maxAnimTime, 10, (float)( 5*Math.PI/180 ), (float)( 20*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleX = (float)mapValueWithClamp(var5.animTime, var5.maxAnimTime, 10, (float)( 165*Math.PI/180 ), (float)( 350*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleY = (float)(0*Math.PI/180);
				...
				ARMTOPRIGROT.rotateAngleX = (float)mapValueWithClamp(var5.animTime, var5.maxAnimTime, 10, (float)( 165*Math.PI/180 ), (float)( 350*Math.PI/180 ));
				ARMTOPRIGROT.rotateAngleY = (float)(0*Math.PI/180);
				...
				ARMTOPLEFROT.rotateAngleX = mapValueWithClamp(attackCounter, max, 10, (float)( -60*Math.PI/180 ), (float)( -10*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleY = mapValueWithClamp(attackCounter, max, 0, (float)( 0*Math.PI/180 ), (float)( 0*Math.PI/180 ));
				ARMTOPLEFROT.rotateAngleZ = mapValueWithClamp(attackCounter, max, 0, (float)( 0*Math.PI/180 ), (float)( 0*Math.PI/180 ));

				ARMBOTLEFROT.rotateAngleX = mapValueWithClamp(attackCounter, max, 10, (float)( -90*Math.PI/180 ), (float)( 0*Math.PI/180 ));
				ARMBOTLEFROT.rotateAngleY = mapValueWithClamp(attackCounter, max, 0, (float)( 0*Math.PI/180 ), (float)( 0*Math.PI/180 ));
				ARMBOTLEFROT.rotateAngleZ = mapValueWithClamp(attackCounter, max, 0, (float)( 0*Math.PI/180 ), (float)( 0*Math.PI/180 ));
		...
		/*
		 * Blocking Animation
		ARMTOPLEFROT.rotateAngleX = (float) (-20*Math.PI/180);
		ARMTOPLEFROT.rotateAngleY = (float) (+10*Math.PI/180);
		ARMTOPLEFROT.rotateAngleZ = (float) (15*Math.PI/180);

		ARMBOTLEFROT.rotateAngleX = (float) (-80*Math.PI/180);
		ARMBOTLEFROT.rotateAngleY = (float) (-30*Math.PI/180);
		ARMBOTLEFROT.rotateAngleZ = (float) (+40*Math.PI/180);

		ARMTOPRIGROT.rotateAngleX = (float) (-30*Math.PI/180);
		ARMTOPRIGROT.rotateAngleY = (float) (-15*Math.PI/180);
		ARMTOPRIGROT.rotateAngleZ = (float) (5*Math.PI/180);

		ARMBOTRIGROT.rotateAngleX = (float) (-60*Math.PI/180);
		ARMBOTRIGROT.rotateAngleY = (float) (+45*Math.PI/180);
		ARMBOTRIGROT.rotateAngleZ = (float) (+30*Math.PI/180);
		 * 
		 * */

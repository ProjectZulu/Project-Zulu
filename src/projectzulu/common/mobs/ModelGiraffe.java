...
public class ModelGiraffe extends ModelBase
{
	...
	public void setLivingAnimations(EntityLiving par1EntityLiving, float par2, float par3, float par4) {
		...
		if(var5.animTime > 0){
			...
			/* Left Side Legs */
			leg1.rotateAngleX = mapValueofSet1ToSet2(var5.animTime, minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( -130*Math.PI/180 ));
			leg1.rotateAngleZ = mapValueofSet1ToSet2(var5.animTime, minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( -30*Math.PI/180 ));
			
			/* Right Side Legs */
			leg2.rotateAngleX = mapValueofSet1ToSet2(var5.animTime, minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( -130*Math.PI/180 ));
			leg2.rotateAngleZ = mapValueofSet1ToSet2(var5.animTime, minTime, maxTime,(float)( 0*Math.PI/180 ),(float)( 30*Math.PI/180 ));
		}

...
public class EntityHorseBrown extends EntityHorseBase{
	...
	public boolean getCanSpawnHere() {
		...
		if (CustomEntityList.HORSEBROWN.modData.get().secondarySpawnRate - rand.nextInt(100) >= 0 && super.getCanSpawnHere() 
		...
		if(CustomEntityList.HORSEBROWN.modData.get().reportSpawningInLog){
			if(wasSuccesful){

...
public class EntityBlackBear extends EntityBear{
	...
	public boolean getCanSpawnHere() {
		...
		if (CustomEntityList.BLACKBEAR.modData.get().secondarySpawnRate - rand.nextInt(100) >= 0 && super.getCanSpawnHere()
				&& worldObj.canBlockSeeTheSky(var1, var2, var3)){
			wasSuccesful = true;
		}
		
		if(CustomEntityList.BLACKBEAR.modData.get().reportSpawningInLog){
			if(wasSuccesful){

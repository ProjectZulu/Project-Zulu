 ...
 */
@Deprecated
public abstract class EntityRideableHerd extends EntityPig
{
    ...
    public EntityRideableHerd(World par1World)
    {
        super(par1World);
    }
    ...
    protected void updateEntityActionState()
    {
        ...
        /*Find player to attakc and sets path to it*/
        ...
        if (this.pathToEntity != null && this.rand.nextInt(100) != 0)
        {
            ...
            if (this.rand.nextFloat() < 0.8F && (var3 || var4) && shouldJumpInWater() )
            {
                this.isJumping = true;
            }
    ...
    protected boolean shouldJumpInWater(){
    	return true;
    }

...
public class EntityHorseWhite extends EntityHorseBase{
	...
	public boolean getCanSpawnHere() {
		...
		if (CustomEntityList.HORSEWHITE.modData.get().secondarySpawnRate - rand.nextInt(100) >= 0 && super.getCanSpawnHere() 
	...
	protected void dropFewItems(boolean par1, int par2){
		...
		for (int i = 0; i < var3; i++) {
			ItemStack loot = CustomEntityList.HORSEWHITE.modData.get().getLootItem(rand);
			if(loot != null){

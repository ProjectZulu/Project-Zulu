...
public class GuiLimitedMobSpawner extends GuiScreen {
    ...
    public void openList(ListType listType) {
        ...
        case Sound:
            if (rootSoundNode.numberOfChildren() == 0) {
                 ...
                 */
                HashMap soundHash;
                if (ObfuscationHelper.isUnObfuscated(SoundPool.class.getDeclaredFields().clone(),
    ...
    public void drawDefaultBackground() {
        ...
        this.mc.renderEngine.bindTexture(DefaultProps.dungeonDiretory + "mobspawnergui.png");

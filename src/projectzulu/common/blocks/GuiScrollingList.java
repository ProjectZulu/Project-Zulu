...
public abstract class GuiScrollingList {
    ...
    public void drawScreen(int mouseX, int mouseY, float p_22243_3_){
        ...
        var18.setColorOpaque_I((160 << 16) + (145 << 8) + 114); // 2105376 // //Inv SLot Grey: (139 << 16) + (139 << 8) + 139
...
//        this.overlayBackground(this.bottom, this.listHeight, 255, 255);
    ...
    private void overlayBackground(int p_22239_1_, int p_22239_2_, int p_22239_3_, int p_22239_4_){
        ...
        var5.addVertexWithUV(0D+leftOffset, (double)p_22239_2_, 0.0D, 0.0D, (double)((float)p_22239_2_ / var6));
        var5.addVertexWithUV((double)this.listWidth + 30+leftOffset, (double)p_22239_2_, 0.0D, (double)((float)(this.listWidth + 30) / var6), (double)((float)p_22239_2_ / var6));
        var5.setColorRGBA_I(4210752, p_22239_3_);
        var5.addVertexWithUV((double)this.listWidth + 30+leftOffset, (double)p_22239_1_, 0.0D, (double)((float)(this.listWidth + 30) / var6), (double)((float)p_22239_1_ / var6));
        var5.addVertexWithUV(0.0D+leftOffset, (double)p_22239_1_, 0.0D, 0.0D, (double)((float)p_22239_1_ / var6));
        var5.draw();
    }
}
